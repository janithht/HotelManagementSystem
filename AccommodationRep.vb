...
Public Class AccommodationRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.AccommodationRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAccommodationRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccommodationRep = New AccommodationRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
