...
Public Class CrystalReportguest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.CrystalReportguest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportguest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportguest = New CrystalReportguest()
        rpt.Site = Me.Site
        Return rpt
    End Function
